...
export function PostCard({ post }) {
  ...
  return (
    <div
      ...
      className="group relative border border-teal-500 hover:border-2 h-[310px] overflow-hidden rounded-lg w-full sm:!w-[300px]  hover:cursor-pointer transition-all"
    >
      <div>
        <img
          src={post.image}

        ...
        <div>
          <div>
            <div>
              ...
              <h1>Last updated: November 14,2024</h1>
              ...
              <ul>
                <li className="mx-5">
                  <p className="md:text-xl">1. Email address</p>
                </li>
                <li className="mx-5">
                  <p className="md:text-xl">2. First name and last name</p>
                </li>
                <li className="mx-5">
              ...
              <ul>
                <li className="m-5">
                  ...
                  <div className="m-2">
                    <p className="md:text-xl">Type: Session Cookies</p>

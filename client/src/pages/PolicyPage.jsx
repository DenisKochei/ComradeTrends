        ...
        <div>
          <div>
            <div>
              ...
              <h3 className="text-xl font-semibold  m-1">1. Interpretation</h3>
              <p className="text-xl">
              ...
              <ul>
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Account:</strong> means a unique
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Affiliate:</strong> means an
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Company:</strong> (referred to
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Cookies:</strong> are small
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Country:</strong> refers to:
                    Kenya
                  </p>
                </li>
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Device:</strong> means any
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Personal Data:</strong> is any
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Service:</strong> refers to the
                    Website.
                  </p>
                </li>
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Service Provider:</strong> means
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Usage Data:</strong> refers to
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Website:</strong> refers to
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">You:</strong> means the
              ...
              <ul>
                <li className="mx-5">
                  <p className="text-xl">1. Email address</p>
                </li>
                <li className="mx-5">
                  <p className="text-xl">2. First name and last name</p>
                </li>
                <li className="mx-5">
                  <p className="text-xl">3. Usage Data</p>
                </li>
              </ul>
              ...
              <ul>
                ...
                <li className="m-5">
                  <strong className="text-xl">Web Beacons.:</strong>
                  <p className="text-xl">
              ...
              <ul>
                <li className="m-5">
                  ...
                  <div className="m-2">
                    <p className="text-xl">Type: Session Cookies</p>
                    <p className="text-xl">Administered by: Us</p>
                  </div>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  ...
                  <div className="m-2">
                  <p className="text-xl">Type: Persistent Cookies</p>
                  <p className="text-xl">Administered by: Us</p>
                  </div>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">Functionality Cookies:</strong>
                  </p>
                  <div className="m-2">
                    <p className="text-xl">Type: Persistent Cookies</p>
                    <p className="text-xl">Administered by: Us</p>
              ...
              <ul>
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">To contact You::</strong> To
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">To provide You:</strong> with
                ...
                <li className="m-5">
                  <p className="text-xl">
                    <strong className="text-xl">For other purposes:</strong>: We
              ...
              <ul>
                <li className="m-5">
                  <strong className="text-xl">With Service Providers::</strong>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <strong className="text-xl">For business transfers::</strong>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <strong className="text-xl">With Affiliates::</strong>{" "}
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <strong className="text-xl">With business partners::</strong>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <strong className="text-xl">With other users::</strong>
                  <p className="text-xl">
                ...
                <li className="m-5">
                  <strong className="text-xl">With Your consent:</strong>:
                  <p className="text-xl">
              ...
              <ul>
                ...
                <li className="mx-5 text-xl">
                  3. Prevent or investigate possible wrongdoing in connection
                  with the Service
                </li>
                <li className="mx-5 text-xl">
              ...
              <h2 className="text-2xl font-semibold  m-3">Contact Us</h2>
              <p className="text-xl">
              ...
              <ul className="m-3">
                <li className="mx-5">
                  <p className="text-xl">By email: <a href='mailto:comradetrends.info@gmail.com'>comradetrends.info@gmail.com</a></p>
                </li>
                <li className="mx-5">
                  <p className="text-xl">By phone number: <a href='tel:+254759117496'>+(254)759117496</a></p>
                </li>
              </ul>
            </div>
          </div>

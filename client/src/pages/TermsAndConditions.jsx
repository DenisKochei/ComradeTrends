    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <section className="mb-4">
        ...
        <ul className="list-disc ml-6">
          <li className="md:text-xl">
            <strong className="font-semibold">Service:</strong> The website and
            any related services provided by Comrade Trends Media, available
            through the URL comradetrends.com.
          </li>
          <li className="md:text-xl">
      ...
      <section className="mb-4">
        ...
        <p className="m-2 md:text-xl">
          ...
          time are hereby incorporated by reference into these Terms. We reserve
          the right to modify these Terms at any time and for any reason at our
          sole discretion. Unless otherwise stated, we will notify you of any
          changes by updating the "Last updated" date of these Terms. You waive
          any right to receive specific notice of each such change.
        </p>
        <p className="m-2 md:text-xl">
          THESE TERMS CONTAIN IMPORTANT DISCLAIMERS (SECTION 2), DISCLAIMERS OF
          WARRANTIES (SECTION 6), LIMITATION OF LIABILITY (SECTION 7), AS WELL
        ...
        <p className="m-2 md:text-xl">
          ...
          OR USE THE WEBSITE AND THE SERVICE.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="m-2 md:text-xl">
          The Service may be modified, updated, interrupted or suspended at any
        ...
        <p className="m-2 md:text-xl">
          ...
          any harm to your computing system, loss of data, or other harm to you
          or any third party, including, without limitation, any bodily harm,
          that results from your access to or use of the Service, or reliance on
      ...
      <section className="mb-4">
        ...
        <p className="m-2 md:text-xl">
          ...
          Company is not responsible for any Third-Party Ads. The Company
          ...
          or through the Service, including payment and delivery of related
